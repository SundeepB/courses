...
class Vgg16():
    ...
    def fit_data(self, trn, labels,  val, val_labels, nb_epochs=1, batch_size=64):
        """
            Trains the model for a fixed number of epochs (iterations on a dataset).
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit(trn, labels, epochs=nb_epochs,
    ...
    def fit(self, batches, val_batches, nb_epoch=1):
        """
            ...
            See Keras documentation: https://keras.io/models/model/
        """
        self.model.fit_generator(batches, steps_per_epoch=batches.samples/batches.batch_size, epochs=nb_epoch, validation_steps=val_batches.samples/val_batches.batch_size)
